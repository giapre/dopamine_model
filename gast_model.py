...
dopa_default_theta = dopa_Theta(
    C=100.0, k=0.7, Delta=0.5, v_r=-60.0, v_theta=-40.0, Bd=1., ga=1.0, gg=1., Ea=0.0, Eg=-80., I=40.0, 
    tau_u=33.33, b=-2.0, kappa=100.0, tau_sa=6.0, tau_sg=6., Ja=15., Jg=15., Jsa=15., Jsg=15., 
    Jdopa=100000.0, Vmax=1300.0, Km=150.0, Rd=1., Sd=-1.0, Z=1., tau_Dp=500.0, tau_Md=500.0, 
